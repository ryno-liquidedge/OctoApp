 ...
 *///--------------------------------------------------------------------------------
class crop_helper extends \LiquidedgeApp\Octoapp\app\app\intf\standard {
    //--------------------------------------------------------------------------------
 	// properties
 	//--------------------------------------------------------------------------------
...
//                rename($this->src, $this->dest_dir."/".$this->base_name);
    ...
    public function xcrop($filename, $options = []){
        ...
        $cropper_request_id = $request->get("cropper_request_id", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_STRING, ["index" => $options["index"]]);
        $crop_x = $request->get("crop_x", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_INT, ["index" => $options["index"]]);
        $crop_y = $request->get("crop_y", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_INT, ["index" => $options["index"]]);
        $crop_width = $request->get("crop_width", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_INT, ["index" => $options["index"]]);
        $crop_height = $request->get("crop_height", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_INT, ["index" => $options["index"]]);
        $crop_x_scale = $request->get("crop_scaleX", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_INT, ["index" => $options["index"]]);
        $crop_y_scale = $request->get("crop_scaleY", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_INT, ["index" => $options["index"]]);
        $desired_width = $request->get("desired_width", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_INT, ["index" => $options["index"]]);
        $desired_height = $request->get("desired_height", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_INT, ["index" => $options["index"]]);
        $crop_rotate = $request->get("crop_rotate", \LiquidedgeApp\Octoapp\app\app\data\data::TYPE_INT, ["index" => $options["index"]]);
        $dest = dirname($filename)."/cropped";

        \com\os::mkdir(dirname($filename)."/cropped");
