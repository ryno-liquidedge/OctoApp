...
class dropzone extends \LiquidedgeApp\Octoapp\app\app\intf\standard {
	...
	protected function __construct($options = []) {
		...
		$this->session =  \LiquidedgeApp\Octoapp\app\app\inc\dropzone\session::make(["id" => $options["id"]]);
    ...
    public static function process_upload($id, callable $fn, $options = []): bool {
        ...
        $dropzone_session =  \LiquidedgeApp\Octoapp\app\app\inc\dropzone\session::make(["id" => $id]);
