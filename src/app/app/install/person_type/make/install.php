<?php
namespace LiquidedgeApp\Octoapp\app\app\install\person_type\make;
/**
 * @package LiquidedgeApp\Octoapp\app\app\install\person_type\make
 * @author Ryno Van Zyl
 * @copyright Copyright Liquid Edge Solutions. All rights reserved.
 */
class install extends \LiquidedgeApp\Octoapp\app\app\install\person_type\master\main{
...
EOD;
	...
	public static function make_db_enties($options = []) {
		...
		return \LiquidedgeApp\Octoapp\app\app\install\person_type\make\install::install_from_solid($options_arr["return_sql"]);
	}
	//--------------------------------------------------------------------------
	public static function install_from_db() {
		...
		foreach ($person_type_arr as $person_type) {
			$install = new \LiquidedgeApp\Octoapp\app\app\install\person_type\make\install($person_type->pty_name, $person_type->pty_code, $person_type->pty_class, $person_type->pty_is_individual);
			$install->install();
