...
class feature_total_king_beds extends \LiquidedgeApp\Octoapp\app\app\solid\property_set\intf\standard {
	...
	public function get_code() {
		return "LISTING_PROPERTY_TOTAL_KING_BEDS";
	}
	//--------------------------------------------------------------------------------
	public function get_key() {
		return "gs1.product:FEATURE:KING_BEDS";
	}
	//--------------------------------------------------------------------------------
