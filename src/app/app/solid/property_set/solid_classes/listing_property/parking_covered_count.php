...
class parking_covered_count extends \LiquidedgeApp\Octoapp\app\app\solid\property_set\intf\standard {
	...
	public function get_code() {
		return "LISTING_PROPERTY_PARKING_COVERED_COUNT";
	}
	//--------------------------------------------------------------------------------
	public function get_key() {
		return "gs1.product.property:PARKING_COVERED_COUNT";
	}
	//--------------------------------------------------------------------------------
