...
class feature_has_flatlet extends \LiquidedgeApp\Octoapp\app\app\solid\property_set\intf\standard {
	...
	public function get_code() {
		return "LISTING_PROPERTY_FEATURE_HAS_FLATLET";
	}
	//--------------------------------------------------------------------------------
	public function get_key() {
		return "gs1.product:FEATURE:HAS_FLATLET";
	}
	//--------------------------------------------------------------------------------
