...
class feature_total_flatlets extends \LiquidedgeApp\Octoapp\app\app\solid\property_set\intf\standard {
	...
	public function get_code() {
		return "LISTING_PROPERTY_TOTAL_FLATLETS";
	}
	//--------------------------------------------------------------------------------
	public function get_key() {
		return "gs1.product:FEATURE:FLATLET";
	}
	//--------------------------------------------------------------------------------
