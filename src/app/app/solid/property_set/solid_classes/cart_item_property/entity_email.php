...
class entity_email extends \LiquidedgeApp\Octoapp\app\app\solid\property_set\intf\standard {
	...
	public function get_code() {
		return "CART_ITEM_PROPERTY_ENTITY_EMAIL";
	}
	//--------------------------------------------------------------------------------
	public function get_key() {
		return "gs1.order.item.entity:email";
	}
	//--------------------------------------------------------------------------------
