...
class company_email extends \LiquidedgeApp\Octoapp\app\app\solid\property_set\solid_classes\settings\intf\standard {
	...
	public function get_default() {
        return \core::$app->get_instance()->get_option("email.contact");
    }
    //--------------------------------------------------------------------------------
}
