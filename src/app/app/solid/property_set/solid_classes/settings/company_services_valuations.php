...
class company_services_valuations extends \LiquidedgeApp\Octoapp\app\app\solid\property_set\solid_classes\settings\intf\standard {
	...
	public function get_code() {
		return "SETTING_COMPANY_SERVICES_VALUATIONS";
	}
	//--------------------------------------------------------------------------------
	public function get_key() {
		return "gs1.setting:COMPANY_SERVICES_VALUATIONS";
	}
	//--------------------------------------------------------------------------------
