...
class company_value_added_services extends \LiquidedgeApp\Octoapp\app\app\solid\property_set\solid_classes\settings\intf\standard {
	...
	public function get_code() {
		return "SETTING_COMPANY_VALUE_ADDED_SERVICES";
	}
	//--------------------------------------------------------------------------------
	public function get_key() {
		return "gs1.setting:COMPANY_VALUE_ADDED_SERVICES";
	}
	//--------------------------------------------------------------------------------
