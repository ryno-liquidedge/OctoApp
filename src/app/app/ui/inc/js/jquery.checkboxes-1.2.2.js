/**
 * http://github.com/rmariuzzo/checkboxes.js
 */
    ...
    var Checkboxes = function () {
        ...
        _createClass(Checkboxes, [{
            ...
            value: function uncheck() {
                var instance = this;
                instance.$context.find(':checkbox:visible').filter(':not(:disabled)').prop('checked', false).trigger('change');
                instance.$last = false;
            ...
            key: 'range_force',
            value: function range_force(enable) {
                if (enable) {
                    var instance = this;
                    ...
                    this.$context.on('click.checkboxes.range', ':checkbox', function (event) {
                        ...
                        if(instance.$context.hasClass('toggled')){
                            instance.$context.find(':checkbox:visible:checked').prop('checked', false);
                            instance.$last = false;
                            $checkbox.prop('checked', true);
                            instance.$context.removeClass('toggled');
                        }
                        ...
                        if (instance.$last) {
                            ...
                            instance.$context.addClass('toggled');
                        }
                        instance.$last = $checkbox;
                    });
                } else {
                    this.$context.off('click.checkboxes.range_force');
                }
            }
        }]);
